<html>
    ...
    <table border="0" width="100%">
        <tr>
             ...
             <td width="100%">
                <table width="50%" border="0"  cellpadding="10" align="right">
                    <tr align="center">
                        ...
                        <td class="myTheme2"><a href="contactPage.html">Contact Us</a></td>
            ...
            <table width="100%" style="opacity: 0.75;" >
            ...
            <marquee  scrollamount="12" direction="left">
                <img src="images/red-brick-wall-3614976__340.jpg" width="800" height="500" alt="red brick wall" />
                <img src="images/photoshop-texture-31.jpg" width="800" height="500" alt="wall 2" />
                <img src="images/wall-1475318__340.jpg" width="800" height="500" alt="wall3" />
                <img src="images/Under-Construction.jpg" width="1200" height="500" alt="construction" />
                <img src="images/observation-urban-building-business-steel_1127-2397.jpg" width="800" height="500" alt="urban" /> 
            </marquee>
     
       
        <div class="myTheme3" style="opacity:0.88;">
            <form action="loginCode.jsp" >
                <table align="center" cellpadding="20">
                  ...
                  <td>Name </td>
                  <td>  
                      <input type="text" name="userid"  placeholder="name"  value="<%=myCookie%>">
                  <hr>
                  </td>
                  ...
                  <tr align="center">
                      <td></td>
                      <td><input type="submit" onclick="validation(form);" style="background:url(images/login2.jpg);width: 105px; height: 35px;" value=""></td>
                  </tr>
                  </table>
                </form>
        </div>
...
The number of lines in a paragraph depends on the size of the browser window. If you resize the browser window, the number of lines in this paragraph will change.
    ...
    <div class="myTheme3" style="opacity:0.95;" >
